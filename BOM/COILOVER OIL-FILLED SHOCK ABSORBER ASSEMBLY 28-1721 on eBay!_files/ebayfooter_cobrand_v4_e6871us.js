...
{new EbayCobrand(this,"MSN","51","msn");new EbayCobrand(this,"Earthlink","52","earthlink");new EbayCobrand(this,"MSNBC","53","msnbc");new EbayCobrand(this,"WORLDOFGOOD","507","worldofgood");o=new EbayCobrand(this,"Carpoint","28","carpoint");o.detectException=function(){var tpp=this.oEnv.sThisPagePath;return(tpp.hasAny("ebaymotors","motors.")||!tpp.hasAny("pages.","www.ebay.com","cgi","listings"));}
